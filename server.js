...
// ==========================
app.get("/", (req, res) =>
  res.json({ status: "ok", recipes: recipes.length, message: "🍪 קוקישף רצה בהצלחה!" })
);
...
app.post("/chat", async (req, res) => {
  try {
    ...
    // otherwise smart contextual reply
